...
export function AboutsMain() {
  return (
    <div className="text-center pt-30 pb-50 sm:pt-32 flex flex-col justify-center items-center space-y-4">
      {/* Google Sheets iframe */}
      <div className="border border-gray-400 rounded-lg p-4 w-full h-screen">
        <iframe
